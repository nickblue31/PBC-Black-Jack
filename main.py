...
def draw_points(window, cardp, cardb):
    ...
    if cardb.showed:
        ...
        window.blit(bankerpt, (WIDTH/2, HEIGHT/2-200))
    ...
    window.blit(playerpt, (WIDTH/2, HEIGHT/2+150))
                ...
                if players_turn:
                    ...
                    if cardb.cards == []:
                        for i in range(2):
                            ...
                            deck.pop(0)
                            deck.pop(0)
                        cardb.cards[0].open = False
                    else:
                        cardp.cards.append(pokers.Card(deck[0][0], deck[0][1]))
                        deck.pop(0)
                else:
                    cardb.cards.append(pokers.Card(deck[0][0], deck[0][1]))
                    deck.pop(0)
